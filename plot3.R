...
plot( power$Sub_metering_1 ~ power$Time,type="n",ylab="Energy sub metering", xlab="")
lines(power$Sub_metering_1 ~ power$Time , col="black")
lines(power$Sub_metering_2 ~ power$Time , col="red")
lines(power$Sub_metering_3 ~ power$Time , col="blue")
